...
public class ContactList extends AppCompatActivity implements ContactAdapter.ItemClicked {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //grouping the contents of table by name
        queryBuilder.setGroupBy("name");

        tvLoad.setText("Getting contacts list..please wait..");
        showProgress(true);
        ...
        Backendless.Persistence.of(Contact.class).find(queryBuilder, new AsyncCallback<List<Contact>>() {
            ...
            public void handleResponse(List<Contact> response) {
                ...
                mAdapter=new ContactAdapter(ContactList.this,ContactApplication.list);
                rvList.setAdapter(mAdapter);
                showProgress(false);
                Toast.makeText(ContactList.this, "Contact List successfully updated!", Toast.LENGTH_SHORT).show();
            }
